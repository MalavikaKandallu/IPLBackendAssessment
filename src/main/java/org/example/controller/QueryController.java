...
public class QueryController {
    ...
    public ResponseEntity<Long> getCumulativeScoreByPlayerName(@PathVariable String playerName) {
        Long cumulativeScore = queryService.getCumulativeScoreByPlayerName(playerName);
